                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                        ...
                        <div class="bg-indigo-700 p-6 rounded-lg shadow-md text-center flex flex-col items-center justify-center space-y-3">
                            ...
                            <a href="{{ route('producto.lista') }}" class="text-white text-lg font-semibold hover:no-underline">Lista de Productos</a>
                        </div>
                        ...
                        <div class="bg-indigo-700 p-6 rounded-lg shadow-md text-center flex flex-col items-center justify-center space-y-3">
                            ...
                            <a href="{{ route('producto-stock.create') }}" class="text-white text-lg font-semibold hover:no-underline">Agregar Stock a Productos</a>
                        </div>
